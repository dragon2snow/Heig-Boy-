...
void sound_driver_init() {
	...
	SetThreadPriority(thread_handle, REALTIME_PRIORITY_CLASS);
}
...
static void win32_sound_init() {
	...
	// Incroyable cet OS, on est OBLIGÉ de créer une fenêtre pour gérer les
	// événements -_-
